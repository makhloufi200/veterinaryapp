...
from .models import AchatMedecine
...
def update_stock(request, stock_id):
	if not request.user.is_authenticated:
		raise Http404
	instance = get_object_or_404(AchatMedecine, pk=stock_id)
